...
![Discord Notification](https://raw.githubusercontent.com/devolutions/powershell-universal-gallery/main/Triggers/Discord/images/notification.png)
...
```powershell
New-PSUTrigger -TriggerScript 'Devolutions.PowerShellUniversal.Triggers.Discord\Send-PSUDiscordNotification' -EventType JobFailed
```
