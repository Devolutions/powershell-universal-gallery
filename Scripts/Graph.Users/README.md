...
These scripts can be added to PowerShell Universal using the Create Script From Command button on Automation \ Scripts. Select the `Devolutions.Graph.Users.Scripts` module and then the command you would like to add. You can then add it to the [portal](https://docs.powershelluniversal.com/portal/portal) for users to execute.
